...
export class BedrockStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const bucketArn = cfn.Fn.importValue('ChatS3BucketArnOutput'); 
    const collectionArn = cfn.Fn.importValue('OpenSearchCollectionArn');
    const bedrockRoleArn = cfn.Fn.importValue('BedrockRoleArn');
